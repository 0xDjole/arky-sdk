...
export type SocialChannelHealthStatus = "connected" | "needs_reconnect" | "missing_scopes";

export interface SocialChannelHealth {
  status: SocialChannelHealthStatus;
  checked_at: number;
  expires_at?: number | null;
  scopes: string[];
...
export interface SocialChannelPublishingCapabilities {
  supported: boolean;
  requires_media: boolean;
  max_media_items?: number | null;
  supports_images: boolean;
  supports_videos: boolean;
  allows_mixed_media: boolean;
}

export interface SocialChannelEngagementCapabilities {
  read_comments: boolean;
  reply_to_comments: boolean;
}

export interface SocialChannelAnalyticsCapabilities {
  read_post_metrics: boolean;
}

export interface SocialChannelCapabilities {
  publishing: SocialChannelPublishingCapabilities;
  engagement: SocialChannelEngagementCapabilities;
  analytics: SocialChannelAnalyticsCapabilities;
}
...
export interface SocialChannel {
  ...
  capabilities: SocialChannelCapabilities;
  created_at: number;
  updated_at: number;
}
...
export interface SocialChannelMetricPoint {
  date: string;
  metrics: SocialChannelMetrics;
}
...
export interface SocialChannelAnalytics {
  ...
  collected_at: number;
  metrics: SocialChannelMetrics;
  series: SocialChannelMetricPoint[];
}

export type SocialChannelCommentStatus = "open" | "replied";

export interface SocialChannelComment {
  id: string;
  integration_id: string;
  provider_id: SocialProviderId;
  ...
  text: string;
  status: SocialChannelCommentStatus;
  created_at: number;
}

export interface SocialChannelCommentPage {
  comments: SocialChannelComment[];
  cursor?: string | null;
}

export type SocialChannelReplyStatus = "sent";

export interface SocialChannelCommentReply {
  id: string;
  integration_id: string;
  comment_id: string;
  status: SocialChannelReplyStatus;
  text: string;
  provider_reply_id: string;
  created_at: number;
}
