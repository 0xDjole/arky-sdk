...
export type {
  ...
  SocialChannelAnalyticsCapabilities,
  SocialChannelCapabilities,
  SocialChannelComment,
  SocialChannelCommentPage,
  SocialChannelCommentReply,
  SocialChannelCommentStatus,
  SocialChannelEngagementCapabilities,
  SocialChannelHealth,
  SocialChannelHealthStatus,
  SocialChannelMetricPoint,
  SocialChannelMetrics,
  SocialChannelPublishingCapabilities,
  SocialChannelReplyStatus,
