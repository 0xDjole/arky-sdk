...
import type { FindMarketsParams, FindStoreLocationsParams, ListPaymentOptionsParams, PaginatedResponse, Market, StoreLocation, PaymentOption } from 'arky-sdk';
...
setup.payment_options[0].configuration;
