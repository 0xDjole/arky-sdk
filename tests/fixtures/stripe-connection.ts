...
import type { ConnectStripePaymentOptionParams, PaymentOptionConnectResponse, StripeConnectionOperation } from 'arky-sdk';
type Admin = ReturnType<typeof createAdmin>;
type True<T extends true> = T;
type Same<A, B> = [A] extends [B] ? ([B] extends [A] ? true : false) : false;
export type ConnectionResponses = [
  True<Same<Awaited<ReturnType<Admin['store']['paymentOption']['stripe']['connect']>>, PaymentOptionConnectResponse>>,
  True<Same<Awaited<ReturnType<Admin['store']['paymentOption']['stripe']['getConnection']>>, StripeConnectionOperation>>,
  True<Same<PaymentOptionConnectResponse['operation'], StripeConnectionOperation>>,
  True<Same<StripeConnectionOperation['metadata_setup_status'], StripeConnectionOperation['account_creation_status'] | null>>
];
