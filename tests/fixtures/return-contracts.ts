...
export type ReturnContract = [
  ...
  True<Same<ReturnLineSource["type"], "order_product" | "rental_placement">>,
  True<Same<keyof Extract<ReturnLineSource, { type: "rental_placement" }>, "type" | "rental_placement_id">>,
  True<"unit_spans" extends keyof Extract<ReturnLineSource, { type: "rental_placement" }> ? false : true>,
