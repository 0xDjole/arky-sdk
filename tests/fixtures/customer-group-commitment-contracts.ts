...
export type SubscriptionControlContract = [
  ...
  True<Same<SubscriptionCollection, { type: "free" } | { type: "saved_method"; customer_payment_method_id: string }>>,
  ...
  True<Same<keyof SubscriptionFundingChange, "subscription_id" | "expected_updated_at" | "expected_previous_revision_id" | "expected_next_occurrence_index" | "first_occurrence" | "end" | "customer_payment_method_id" | "reason">>,
